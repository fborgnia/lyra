...
# This file is a 1:1 copy of the self-attention mechanism from
# huggingface/transformers for the Gemma 3 model.
# All comments and structure are preserved to facilitate diffs
...
class LyraAttention(nn.Module):
    """
    A 1:1 copy of Gemma3Attention from the transformers library.
    """
